...
const Homepage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-32">
        <div className="text-center">
          <div className="inline-flex items-center space-x-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-8">
            ...
            <span className="text-white text-sm">Built for Real-time Collaboration</span>
          </div>
          ...
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto leading-relaxed">
            Experience the future of collaborative drawing. Create infinite canvases, 
            work together in real-time, and bring your ideas to life with our 
            powerful whiteboard platform.
          </p>

          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-16">
            <div 
              className="group relative bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-500  transform hover:scale-105"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Individual Canvas</h3>
                <p className="text-white/70 mb-6 text-left">
                  Start drawing immediately on your personal canvas. Perfect for brainstorming, 
                  sketching ideas, or creating diagrams solo.
                </p>
                
                <div className="flex items-center justify-between">
                  <button onClick={()=>navigate(`/whiteboard?Id=${Math.random().toString(36).substring(2, 15)}`)} className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 cursor-pointer flex items-center space-x-2 group-hover:shadow-lg group-hover:shadow-purple-500/25">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Collaborative Room</h3>
                <p className="text-white/70 mb-6 text-left">
                  Create or join a room to collaborate with your team in real-time. 
                  Share ideas, draw together, and see changes instantly.
                </p>
                
                <div className="flex items-center justify-between">
                  <button onClick={()=>setIsGroupCreateOpen(true)} className="bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300 cursor-pointer flex items-center space-x-2 group-hover:shadow-lg group-hover:shadow-pink-500/25">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pb-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div key={index} className="group bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-all duration-300 hover:border-white/20">
      ...
      {isGroupCreateOpen && (
        <JoinRoom setIsGroupCreateOpen={setIsGroupCreateOpen} />)}
    </div>
  );
};
